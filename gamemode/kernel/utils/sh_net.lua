...
if CLIENT then
	net.Receive("net.global", function()
		local key, value = net.ReadNetVar(1)

		Net.globals[key] = value
	end)

	net.Receive("net.local", function()
	...
	net.Receive("net.entity", function()
	...
	net.Receive("net.player", function()
		local index = net.ReadUInt(16)
	...
	net.Receive("net.flush.player", function()
		Net.players[net.ReadUInt(16)] = nil
	end)

	net.Receive("net.flush.entity", function()
		Net.entities[net.ReadUInt(16)] = nil
	end)

	net.Receive("net.local.clear", function()
	...
	net.Receive("net.entity.clear", function()
		local index = net.ReadUInt(16)
	...
	net.Receive("net.player.clear", function()
		local index = net.ReadUInt(16)
	...
	net.Receive("net.global.clear", function()
		local key = Net.vars_id[1][net.ReadUInt(Net.var_max[1])]

		Net.globals[key] = nil
	end)
else
	util.AddNetworkString("net.global")
	util.AddNetworkString("net.local")
	util.AddNetworkString("net.entity")
	util.AddNetworkString("net.player")
	util.AddNetworkString("net.flush.entity")
	util.AddNetworkString("net.flush.player")
	util.AddNetworkString("net.global.clear")
	util.AddNetworkString("net.local.clear")
	util.AddNetworkString("net.entity.clear")
	util.AddNetworkString("net.player.clear")
end
