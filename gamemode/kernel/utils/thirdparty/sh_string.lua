...
function mono.string.Explode( seperators, str )
...
if CLIENT then
	...
	function mono.string.WrapText( text, font, wLimit, dotLimit )
		local lines = {}
		local index = 1
		...
		local words = mono.string.Explode( {" ", "\n"}, text )
